...
import {httpCode301Handler, httpCode401Handler, httpCodeDefaultHandler} from "./http/HttpCodeHandler";
...
//添加一个301错误状态的处理者
httpErrorHandler.addErrorCodeHandler(301, httpCode301Handler)
    .addErrorCodeHandler(401, httpCode401Handler);
